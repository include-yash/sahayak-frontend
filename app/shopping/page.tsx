...
export default function ShoppingPage() {
  ...
  useEffect(() => {
    ...
    speak(t("shopping_welcome"), language)
  ...
  const askGemini = async (prompt: string) => {
    ...
    const modePrompt = `You are a shopping assistant. Suggest nearby stores or products${
      location ? ` near latitude ${location.latitude}, longitude ${location.longitude}` : ""
    }: `
